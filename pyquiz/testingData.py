...
tooEarlyData = [('_charset_', u'UTF-8'), ('__formid__', u'deform'),
        ('name', u'Short Answer'), ('attempts', u'2'),
        ('start_date', u'3011-08-17'),
		('end_date', u'3011-08-17'),
		('test_type', u'assignment'),
        ('__start__', u'questions:sequence'),
        ('__end__', u'questions:sequence'),
        ('__start__', u'short_answer_questions:sequence'),
...
tooLateData = [('_charset_', u'UTF-8'), ('__formid__', u'deform'),
        ('name', u'Short Answer'), ('attempts', u'2'),
        ('start_date', u'1011-08-17'),
		('end_date', u'1011-08-17'),
		('test_type', u'assignment'),
        ('__start__', u'questions:sequence'),
        ('__end__', u'questions:sequence'),
        ('__start__', u'short_answer_questions:sequence'),
...
noAttemptsData = [('_charset_', u'UTF-8'), ('__formid__', u'deform'),
        ('name', u'Short Answer'), ('attempts', u'0'),
        ('start_date', u'2011-08-17'),
		('end_date', u'2011-08-17'),
		('test_type', u'assignment'),
        ('__start__', u'questions:sequence'),
