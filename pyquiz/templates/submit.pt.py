...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_57789008 = _loads('(dp1\nVhref\np2\nV${link}\np3\ns.')
    _attrs_57787472 = _loads('(dp1\n.')
    _attrs_57788112 = _loads('(dp1\nVid\np2\nVwrap\np3\ns.')
    _attrs_57788496 = _loads('(dp1\nVclass\np2\nVmiddle align-center\np3\ns.')
    _attrs_57787536 = _loads('(dp1\nVcontent\np2\nVtext/html;charset=UTF-8\np3\nsVhttp-equiv\np4\nVContent-Type\np5\ns.')
    _attrs_57787920 = _loads('(dp1\n.')
    _attrs_57787728 = _loads("(dp1\nVhref\np2\nV${request.static_url('pyquiz:static/favicon.ico')}\np3\nsVrel\np4\nVshortcut icon\np5\ns.")
    _attrs_57789136 = _loads('(dp1\nVhref\np2\nV${question[1]}\np3\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_57788816 = _loads('(dp1\n.')
    _attrs_57787216 = _loads('(dp1\n.')
    _attrs_57787664 = _loads('(dp1\nVcontent\np2\nVpyramid web application\np3\nsVname\np4\nVdescription\np5\ns.')
    _attrs_57787600 = _loads('(dp1\nVcontent\np2\nVpython web application\np3\nsVname\np4\nVkeywords\np5\ns.')
    _attrs_57788304 = _loads('(dp1\nVid\np2\nVmiddle\np3\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_57787152 = _loads('(dp1\nVxml:lang\np2\nVen\np3\nsVxmlns\np4\nVhttp://www.w3.org/1999/xhtml\np5\ns.')
    _attrs_57788688 = _loads('(dp1\n.')
    _attrs_57787856 = _loads('(dp1\n.')
    _attrs_57788944 = _loads('(dp1\n.')
    def render(econtext, rcontext=None):
        ...
        if (_tmp is not None):
            ...
            _write(_tmp)
        _write(u'</h1>\n</head>\n')
        attrs = _attrs_57787920
        _write(u'<body>\n  ')
        attrs = _attrs_57788112
        _write(u'<div id="wrap">\n\n    ')
        attrs = _attrs_57788304
        _write(u'<div id="middle">\n      ')
        attrs = _attrs_57788496
        _write(u'<div class="middle align-center">\n\n        ')
        attrs = _attrs_57788688
        u'questions'
        ...
        for question in _tmp1:
            _tmp2 = (_tmp2 - 1)
            attrs = _attrs_57788816
            _write(u'<ul>\n            ')
            attrs = _attrs_57788944
            _write(u'<li>')
            attrs = _attrs_57789136
...
__filename__ = '/home/jboisture/buildout/pyquiz/templates/submit.pt'
