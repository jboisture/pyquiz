...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_71948432 = _loads('(dp1\nVid\np2\nVmiddle\np3\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_71946384 = _loads("(dp1\nVhref\np2\nV${request.static_url('pyquiz:static/favicon.ico')}\np3\nsVrel\np4\nVshortcut icon\np5\ns.")
    _attrs_71947984 = _loads('(dp1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_71891536 = _loads('(dp1\n.')
    _attrs_71949776 = _loads('(dp1\nVclass\np2\nVmiddle align-center\np3\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_71949392 = _loads('(dp1\nVcontent\np2\nVpyramid web application\np3\nsVname\np4\nVdescription\np5\ns.')
    _attrs_71948304 = _loads('(dp1\n.')
    _attrs_71949584 = _loads('(dp1\n.')
    _attrs_71948816 = _loads('(dp1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_71950032 = _loads('(dp1\nVid\np2\nVwrap\np3\ns.')
    _attrs_71949328 = _loads('(dp1\n.')
    _attrs_71948176 = _loads('(dp1\nVcontent\np2\nVpython web application\np3\nsVname\np4\nVkeywords\np5\ns.')
    _attrs_71950096 = _loads('(dp1\nVxml:lang\np2\nVen\np3\nsVxmlns\np4\nVhttp://www.w3.org/1999/xhtml\np5\ns.')
    _attrs_71949200 = _loads('(dp1\n.')
    _attrs_71946768 = _loads('(dp1\n.')
    _attrs_71947856 = _loads('(dp1\n.')
    _attrs_71946512 = _loads('(dp1\nVhref\np2\nV/\ns.')
    _attrs_71949456 = _loads('(dp1\nVcontent\np2\nVtext/html;charset=UTF-8\np3\nsVhttp-equiv\np4\nVContent-Type\np5\ns.')
    def render(econtext, rcontext=None):
        ...
        if (_tmp is not None):
            ...
            _write(_tmp)
        _write(u'</h1>\n</head>\n')
        attrs = _attrs_71949584
        _write(u'<body>\n  ')
        attrs = _attrs_71950032
        _write(u'<div id="wrap">\n\n    ')
        attrs = _attrs_71948432
        _write(u'<div id="middle">\n      ')
        attrs = _attrs_71949776
        _write(u'<div class="middle align-center">\n\n        ')
        attrs = _attrs_71949200
        _write(u'<h3>Results:</h3>\n        ')
        attrs = _attrs_71949328
        u'message'
        _write(u'<p>')
        ...
        for question in _tmp1:
            _tmp2 = (_tmp2 - 1)
            attrs = _attrs_71946768
            _write(u'<ul>\n            ')
            attrs = _attrs_71891536
            u'question'
            _write(u'<li>')
            _tmp3 = question
            _tmp = _tmp3
            ...
            _write(' ')
        _write(u'\n        ')
        attrs = _attrs_71946512
        _write(u'<a href="/">return home</a>\n      </div>\n    </div>\n  </div>\n</body>\n</html>')
        return _out.getvalue()
    return render

__filename__ = '/home/jboisture/buildout/pyquiz/templates/grade_test.pt'
